...
import { loadFilm, loadFilms, loadPromo, setIsDataLoaded } from './action';
...
type fetchFilmActionArgs = {
  id : number,
}

export const fetchFilmAction = createAsyncThunk<void, fetchFilmActionArgs, { dispatch: AppDispatch, state: State, extra: AxiosInstance}>(
  'loadFilm',
  async (_args, {dispatch, extra: api}) => {
